...
function getAccessSecret(): string {
  return process.env.JWT_ACCESS_SECRET || env?.JWT_ACCESS_SECRET || defaultAccessSecret;
}

function getRefreshSecret(): string {
  return process.env.JWT_REFRESH_SECRET || env?.JWT_REFRESH_SECRET || defaultRefreshSecret;
}
